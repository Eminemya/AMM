%% Uses CSP, hilbert transform to auto gain each level and orientation independently 
% Lower frequency levels are auto-gained to 

function [ outName ] = processAutoGain001( vidFile, maxPix, sigma, fl, fh, fs, figDir, frameRange)
   ...
   for l = 2:ht-1
      ...
      alpha = maxPixLevels(l)./(eps+timeAmplitude);
