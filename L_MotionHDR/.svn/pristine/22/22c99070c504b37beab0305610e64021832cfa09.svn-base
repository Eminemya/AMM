%% Uses CSP, absolute value to auto gain each level and orientation independently 
% Lower frequency levels are auto-gained less

function [ outName ] = processAutoGain002( vidFile, maxPix, sigma, fl, fh, fs, figDir, frameRange)
